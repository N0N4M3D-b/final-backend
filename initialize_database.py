...
CREATE_DELETED_PROFILES_TABLE = '''CREATE TABLE DeletedProfiles (
    email varchar(45) NOT NULL PRIMARY KEY,
    name varchar(45) NOT NULL,
    password varchar(20) NOT NULL,
    tel varchar(13) NOT NULL
...
queries = (CREATE_WHITELIST_TABLE, CREATE_PROFILES_TABLE, CREATE_DELETED_PROFILES_TABLE, CREATE_UNSOLVEDCASE_TABLE, CREATE_SOLVEDCASE_TABLE)
